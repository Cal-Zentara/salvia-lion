...
- **Shop FULLY polished (2026-06-06):** Shop icon = SalviaLionLogo.png (green-circle lion). Tagline = "Reiki-charged bath salts, made by a Reiki Master 🦁". Shop announcement + full About story added (Nancy's real Q1 voice — Reiki changed my life, Certified Reiki Master, "if I reach even one person that's enough"). Big Banner uploaded — generated via Higgsfield/nano_banana_pro (deep black, teal+purple line-art lion, "SALVIA LION" + tagline, botanical row of epsom salt/lavender/eucalyptus/sage/neroli/white tea at bottom). Returns policy (30 days, buyer-responsible) covers both listings.
  - **Banner gotcha:** Etsy Big Banner is ~4:1 (wide/short); generator max is 21:9, so banners get cropped top/bottom. Fix = compose content in center band, then crop/widen to 1600×400 with Pillow. Tried an edited "shrink botanicals 20%" version — Cal didn't like it, used a clean generated one instead.
- **Seller photo available:** Nancy's real headshot at `pics/Webpage/Warm smile and soft curls (1).webp` — not yet added to Etsy "Shop members" bio. Suggested bio written (her voice). Optional next polish.
- **Still optional:** Etsy "Shop members" personal bio + photo; featured listing; shop sections.
